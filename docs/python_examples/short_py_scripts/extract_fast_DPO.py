"""
Fast extraction script for DPO/MSO 5000/7000/70000 series - based on working debug version
...
# Look for specific DPO manual file
target_filename = "MSO-DPO5000-B-DPO7000-C-DPO70000.docx"
docx_path = os.path.join(parent_dir, target_filename)

if not os.path.exists(docx_path):
    print(f"ERROR: Word document not found: {target_filename}")
    print(f"Expected location: {docx_path}")
    sys.exit(1)
...
output_path = os.path.join(parent_dir, "public", "commands", "MSO_DPO_5k_7k_70K.json")
